...
function displayLatestLaunches(data) {
	...
	x = '<h4>' + data.mission_name + '</h4>' +
		...
		'<a href=' + data.links.video_link + ' target="_blank">View launch video' + '</a>' +
		'<a href=' + data.links.article_link + ' target="_blank">Learn more' + '</a>';
...
function displayPreLaunches(data) {
	...
	for (i in data) {
		...
		x += '<div class="pre-launch-div">' +
			...
			'<a href=' + data[i].links.video_link + ' target="_blank">View launch' + '</a>' +
			'<a href=' + data[i].links.article_link + ' target="_blank">Learn more' + '</a>' +
			'</div>';
	}
